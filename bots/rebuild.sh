...
# run new bots
docker run --name selenium -h selenium --net=megamindnetwork -p 4444:4444 -p 8081:8080 -p 5901:5900 --link=robots:robots -d -v /Users/briancullinan/Documents/robots/node-selenium/:/usr/src -v /Users/briancullinan/Documents/robots/bots/defaultProfile:/usr/profile megamind/selenium
docker run --name robots -h robots --net=megamindnetwork -e WEBDRIVER_HOST=selenium --link selenium:selenium -p 8080:8080 -p 3690:3690 -d -v /Users/briancullinan/Documents/svn/:/var/svn -v /Users/briancullinan/Documents/robots/bots/:/usr/src -v /Users/briancullinan/Documents/robots/bots/defaultProfile:/usr/profile -v /Users/briancullinan/Contacts:/data/contacts megamind/bots
